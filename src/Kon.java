...
public class Kon {
    ...
    static float pi= (float) 3.14159;
     ...
     public static float slantHeight (float radius, float height, float slant_height) {
     ...
     public static float surfaceArea(float radius, float height, float slant_height) {
